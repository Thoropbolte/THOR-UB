...
if ENV:
    ...
    class Config(object):
        ...
        TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "ThorBot")
       ...
       # PLUGIN_CHANNEL = int(os.environ.get("PLUGIN_CHANNEL", None))
        UPSTREAM_REPO = os.environ.get(
            "UPSTREAM_REPO", "https://github.com/ThorBotOP/ThorBot"
        )
        ...
        EXTRA_THORBOT = os.environ.get("EXTRA_THORBOT", -1001221881562)
        PM_DATA = os.environ.get("PM_DATA", "ENABLE")
        THORBOT_LOGGER = int(os.environ.get("THORBOT_LOGGER", None))
