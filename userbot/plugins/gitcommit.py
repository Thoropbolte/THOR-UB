...
async def download(event):
    ...
    if Var.GIT_REPO_NAME is None:
        ...
        return
    thorbot = await edit_or_reply(event, "Processing ...")
    ...
    try:
        ...
        await thorbot.edit("Committing to Github....")
        await git_commit(downloaded_file_name, thorbot)


async def git_commit(file_name, thorbot):
    content_list = []
    ...
    for i in content_list:
        ...
        if i == 'ContentFile(path="' + file_name + '")':
            return await thorbot.edit("`File Already Exists`")
            create_file = False
    ...
    if create_file == True:
        ...
        try:
            ...
            await thorbot.edit("Cannot Upload Plugin")
    else:
        return await thorbot.edit("`Committed Suicide`")
