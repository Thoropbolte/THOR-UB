...
# porting to thorbot by @kraken_the_badass...
...
from thorbot.utils import admin_cmd, sudo_cmd, edit_or_reply, progress
    ...
    async with borg.conversation("@DeezLoadBot") as conv:
        try:
            ...
            await borg.send_file(
                event.chat_id,
                songh,
                caption="🔆**Here's the requested song!**🔆\n`Check out` [ThorBot](https://t.me/ThorBot_Chit_Chat)",
            )
            await event.delete()
        except YouBlockedUserError:
