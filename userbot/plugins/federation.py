...
# By @Surv_ivor
# fixed some issues by @THEONLYTHOR
...
BOTLOG_CHATID = Config.THORBOT_LOGGER

THORBOT_LOGGER = os.environ.get("THORBOT_LOGGER", None)
if THORBOT_LOGGER:
    THORBOT_LOGGER = int(THORBOT_LOGGER)
