...
@thorbot.on(admin_cmd(pattern="sin ?(.*)"))
@thorbot.on(sudo_cmd(pattern="sin ?(.*)", allow_sudo=True))
...
@thorbot.on(admin_cmd(pattern="cos ?(.*)"))
@thorbot.on(sudo_cmd(pattern="cos ?(.*)", allow_sudo=True))
...
@thorbot.on(admin_cmd(pattern="tan ?(.*)"))
@thorbot.on(sudo_cmd(pattern="tan ?(.*)", allow_sudo=True))
...
@thorbot.on(admin_cmd(pattern="cosec ?(.*)"))
@thorbot.on(sudo_cmd(pattern="cosec ?(.*)", allow_sudo=True))
...
@thorbot.on(admin_cmd(pattern="sec ?(.*)"))
@thorbot.on(sudo_cmd(pattern="sec ?(.*)", allow_sudo=True))
...
@thorbot.on(admin_cmd(pattern="cot ?(.*)"))
@thorbot.on(sudo_cmd(pattern="cot ?(.*)", allow_sudo=True))
...
@thorbot.on(admin_cmd(pattern="square ?(.*)"))
@thorbot.on(sudo_cmd(pattern="square ?(.*)", allow_sudo=True))
...
@thorbot.on(admin_cmd(pattern="cube ?(.*)"))
@thorbot.on(sudo_cmd(pattern="cube ?(.*)", allow_sudo=True))
