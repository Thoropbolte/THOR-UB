...
from thorbot.Config import Config
from thorbot.plugins.sql_helper.fban_sql import (
    add_channel,
    get_all_channels,
    in_channels,
    rm_channel,
...
@thorbot.on(admin_cmd(pattern="fban ?(.*)"))
@thorbot.on(sudo_cmd(pattern="fban ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@thorbot.on(admin_cmd(pattern="unfban ?(.*)"))
@thorbot.on(sudo_cmd(pattern="unfban ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    mssg = await eor(event, "`...`")
...
@thorbot.on(admin_cmd(pattern=r"fadd ?(.*)"))
@thorbot.on(sudo_cmd(pattern=r"fadd ?(.*)", allow_sudo=True))
...
@thorbot.on(admin_cmd(pattern=r"fremove ?(.*)"))
@thorbot.on(sudo_cmd(pattern=r"fremove ?(.*)", allow_sudo=True))
...
@thorbot.on(admin_cmd(pattern="fgroups"))
@thorbot.on(sudo_cmd(pattern="fgroups", allow_sudo=True))
...
@thorbot.on(admin_cmd(pattern="fsearch ?(.*)"))
@thorbot.on(sudo_cmd(pattern="fsearch ?(.*)", allow_sudo=True))
...
@thorbot.on(admin_cmd(pattern="newfed ?(.*)", outgoing=True))
@thorbot.on(sudo_cmd(pattern="newfed ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    ...
    async with borg.conversation(chat) as conv:
        try:
            ...
            await event.client.send_message(chat, f"/newfed {thor_input}")
...
@thorbot.on(admin_cmd(pattern="renamefed ?(.*)"))
@thorbot.on(sudo_cmd(pattern="renamefed ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return 
    thor_input = event.pattern_match.group(1)
    ...
    async with event.client.conversation(chat) as conv:
          try:     
              ...
              await event.client.send_message(chat, f"/renamefed {thor_input}")
              response = await response 
          except YouBlockedUserError: 
...
@thorbot.on(admin_cmd(pattern="fstat ?(.*)"))
@thorbot.on(sudo_cmd(pattern="fstat ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    thor = await event.edit("`Collecting fstat....`")
    thumb = thor_logo
    if event.reply_to_msg_id:
        previous_message = await event.get_reply_message()
        ...
        async with borg.conversation(bot) as conv:
            try:
                ...
                if "Looks like" in massive.text:
                    ...
                    massive = await conv.get_response()
                    await thorbot.send_file(
                        event.chat_id,
                        massive,
                        thumb=thumb,
                        caption=f"List of feds {user} has been banned in.\n\n**⚡ [Collected using ThorBot](t.me/ThorBot_Support) ⚡**",
                    )
                else:
                    await borg.send_message(event.chat_id, massive.text)
                await event.delete()
            except YouBlockedUserError:
                await thor.edit("`Please Unblock` @MissRose_Bot")


@thorbot.on(admin_cmd(pattern="fedinfo ?(.*)"))
@thorbot.on(sudo_cmd(pattern="fedinfo ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    thor = await eor(event, "`Fetching fed info.... please wait`")
    lavde = event.pattern_match.group(1)
    async with borg.conversation(bot) as conv:
        try:
            await conv.send_message("/start")
            ...
            massive = await conv.get_response()
            await thor.edit(massive.text + "\n\n**LEGENDARY_AF_THORBOT**")
        except YouBlockedUserError:
            await thor.edit("`Please Unblock` @MissRose_Bot")
