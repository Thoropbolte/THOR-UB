...
@thorbot.on(admin_cmd(pattern=r"unpack", outgoing=True))
@thorbot.on(sudo_cmd(pattern=r"unpack"))
async def _(event):
...
@thorbot.on(admin_cmd(pattern="repack ?(.*)", outgoing=True))
@thorbot.on(sudo_cmd(pattern="repack ?(.*)", allow_sudo=True))
async def _(event):
