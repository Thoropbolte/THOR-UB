...
async def carbon_api(e):
    ...
    thor = await edit_or_reply(e, "`Carbonizing...\n25%`")
    ...
    await thor.edit("`Processing..\n75%`")
    # Waiting for downloading
    await asyncio.sleep(2)
    await thor.edit("`Done Dana Done...\n100%`")
    file = "./carbon.png"
    await thor.edit("`Uploading..`")
    await e.client.send_file(
        e.chat_id,
        file,
        caption="Here's your carbon, \n Carbonised by ThorBot",
        force_document=True,
...
async def carbon_api(e):
    if e.fwd_from:
        return
    thor = await edit_or_reply(e, "`Processing....`")
    CARBON = "https://carbon.now.sh/?l={lang}&code={code}"
    textx = await e.get_reply_message()
    pcode = e.text
    if pcode[5:]:
...
async def carbon_api(e):
    ...
    await thor.edit("🔳🔳🔳🔳🔳")
    file = "./carbon.png"
    await thor.edit("☣️Karbon1 Completed, Uploading Karbon☣️")
    await e.client.send_file(
        e.chat_id,
        file,
        force_document=True,
    ...
    os.remove("./carbon.png")
    # Removing carbon.png after uploading
    await thor.delete()  # Deleting msg
...
async def carbon_api(e):
    ...
    await thor.edit("🔘🔘🔘🔘🔘")
    file = "./carbon.png"
    await thor.edit("☣️Karbon2 Completed, Uploading Karbon☣️")
    await e.client.send_file(
        e.chat_id,
        file,
...
async def carbon_api(e):
    ...
    await thor.edit("🔵🔵🔵🔵🔵")
    file = "./carbon.png"
    await thor.edit("☣️Karbon3 Completed, Uploading Karbon⬆️")
    await e.client.send_file(
        e.chat_id,
        file,
...
async def carbon_api(e):
    ...
    await thor.edit("🌝🌝🌝🌝🌝")
    file = "./carbon.png"
    await thor.edit("✅Karbon4 Completed, Uploading Karbon✅")
    await e.client.send_file(
        e.chat_id,
        file,
...
async def carbon_api(e):
    ...
    await thor.edit("⬛⬛⬛⬛⬛")
    file = "./carbon.png"
    await thor.edit("✅RGB Karbon 2.0 Completed, Uploading Karbon✅")
    await e.client.send_file(
        e.chat_id,
        file,
...
async def carbon_api(e):
    ...
    await thor.edit("⬛⬛⬛⬛⬛")
    file = "./carbon.png"
    await thor.edit("✅RGB Karbon Completed, Uploading Karbon✅")
    await e.client.send_file(
        e.chat_id,
        file,
        caption=f"Here's your karbonrgb",
