...
async def _(event):
    ...
    OUTPUT = f"**Files in [ThorBot](t.me/ThorBot_Support) DOWNLOADS Folder:**\n"
...
CmdHelp("filemanager").add_command(
  'ls_local', None, 'Gives the list of downloaded medias in your thorbot server.'
).add_command(
  'ls_root', None, 'Gives the list of all files in root directory of thorbot repo.'
).add_command(
  'ls_saved', None, 'Gives the list of all files in Saved directory of your thorbot server'
).add_command(
